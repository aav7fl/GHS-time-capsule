...
//            }
//            else {
            superfish.b.inj(window.document, superfish.b.cdnJQUrl, 1,
                function(){
                    spsupport.p.$ = window.jQuery.noConflict(true);
                    spsupport.api.jQLoaded();
                });
//            }
            
//            spsupport.sites.searchget();
//            // spsupport.log("dl; sSite = " + superfish.sg.sSite);
...
//            }
//            
//            // spsupport.log("isIE = " + window.sufio.isIE);
//
//            setTimeout( function(){
            ...
            for( var i = 0; i < images.length; i++ ){
                ...
                if( imgType ){
                    ...
                    if( !superfish.b.multiImg ){
                        ...
                        // spsupport.log("before validate " + images[i].src);
...
//                        }
    ...
    validateSU: function( im, iT ){
        ...
        if( spsupport.sites.su() && !sp.prodPage.s &&
            ...
            // spsupport.log("2 sp.prodPage.s " + sp.prodPage.s);        
            sp.prodPage.s = 1;
            //            if (pp) {
            sp.prodPage.i ++;
            sp.pageType = "PP";
